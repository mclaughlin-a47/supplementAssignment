...
class UUDate
{
    ...
    // Friend function for supplementary Assignment - to calculate days
    friend std::string CalculateDateFwd(UUDate& date, int days);
    friend std::string CalculateWorkingDateFwd(UUDate& date, int days);
